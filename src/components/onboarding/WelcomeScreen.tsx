...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onStart }) => {
  ...
  return (
    ...
    >
      ...
      <motion.h1
        className="text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-hero mb-3 sm:mb-4"
      ...
      <motion.p
        className="text-secondary-700 text-base sm:text-lg mb-6 sm:mb-8 max-w-md mx-auto px-2 sm:px-0"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 text-primary-600">
          <div className="w-2 h-2 rounded-full bg-primary-600"></div>
          <span className="text-sm sm:text-base">Takes only 5 minutes</span>
        </div>
        <div className="flex items-center justify-center gap-2 text-primary-600">
          <div className="w-2 h-2 rounded-full bg-primary-600"></div>
      ...
      >
        <button
          onClick={onStart}
          className="primary-button flex items-center justify-center gap-2 px-4 sm:px-8 py-3 sm:py-4 mx-auto text-base sm:text-lg bg-gradient-hero shadow-md hover:shadow-lg transform hover:-translate-y-1"
        >
      ...
      >
        Join thousands who have improved their leadership skills with {COACH_NAME}
      </motion.p>
    </motion.div>
  );
}; 